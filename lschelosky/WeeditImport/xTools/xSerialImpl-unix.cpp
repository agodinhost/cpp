/*!
** \file    xSerialImpl-unix.cpp
** \brief   Unix implementation of the Serial class interface.
**          This implementation is based off termios.h and uses select
**          for multiplexing the IO ports.
